                ...
                <div class="project-preview-card">
                  <v-card class="mx-auto my-5" max-width="344">
                    ...
                    <v-card-actions>
                      ...
                      >
                        <v-card tile>
                          <v-toolbar flat color="transparent" height="50px">
                            <v-btn icon @click="item.showOverlay = false">
                          ...
                          <v-card-text>
                            <div
                              class="default-card default-shadow overlay-container"
                              data-aos="fade-in"
                              data-aos-delay="300"
